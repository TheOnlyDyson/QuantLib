...
*/
//! Set Coupon Pricer
void setCouponPricer_ext(const Leg& leg, const boost::shared_ptr<FloatingRateCouponPricer>&);
//! Set Coupon Pricers
void setCouponPricers_ext(const Leg& leg, const std::vector<boost::shared_ptr<FloatingRateCouponPricer> >&);
