...
class PricerSetter : public AcyclicVisitor,
                     ...
                     public Visitor<SubPeriodsCoupon_ext> {
private:
...
public:
    ...
    void visit(SubPeriodsCoupon_ext& c);
};
...
void PricerSetter::visit(SubPeriodsCoupon_ext& c) {
...
void setCouponPricer_ext(const Leg& leg, const boost::shared_ptr<FloatingRateCouponPricer>& pricer) {
...
void setCouponPricers_ext(const Leg& leg, const std::vector<boost::shared_ptr<FloatingRateCouponPricer> >& pricers) {
