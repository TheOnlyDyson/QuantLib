...
#ifndef quantext_resetable_cross_ccy_swap_helper_hpp
#define quantext_resetable_cross_ccy_swap_helper_hpp
...
/*! Rate helper for bootstrapping over cross currency basis (MtM reset) swap spreads
    ...
    \ingroup termstructures
*/
class ResetableCrossCurrencySwapHelper : public RelativeDateRateHelper {
public:
    ResetableCrossCurrencySwapHelper(
    ...
    //! \name inspectors
    //@{
    boost::shared_ptr<ResetableCrossCurrencySwap> swap() const { return swap_; }
    //@}
    //! \name Visitability
    //@{
...
protected:
    ...
    boost::shared_ptr<ResetableCrossCurrencySwap> swap_;
