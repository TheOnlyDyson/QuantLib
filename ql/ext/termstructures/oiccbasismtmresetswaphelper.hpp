...
#ifndef quantext_oi_cross_ccy_basis_mtmreset_swap_helper_hpp
#define quantext_oi_cross_ccy_basis_mtmreset_swap_helper_hpp
...
/*! Rate helper for bootstrapping over cross currency basis (MtM reset) swap spreads
    ...
    \ingroup termstructures
*/
class OvernightIndexedBasisMtMResetSwapHelper : public RelativeDateRateHelper {
public:
    OvernightIndexedBasisMtMResetSwapHelper(
        ...
        boost::optional<Period> foreignTenor = boost::none,
        boost::optional<Period> domesticTenor = boost::none);
    ...
    //! \name inspectors
    //@{
    boost::shared_ptr<OvernightIndexedBasisMtMResetSwap> swap() const { return swap_; }
    //@}
    //! \name Visitability
    //@{
...
protected:
    ...
    boost::shared_ptr<OvernightIndex> foreignCcyIndex_;
    boost::shared_ptr<OvernightIndex> domesticCcyIndex_;
    ...
    Period foreignTenor_;
    Period domesticTenor_;

    Currency foreignCurrency_;
    Currency domesticCurrency_;
    boost::shared_ptr<OvernightIndexedBasisMtMResetSwap> swap_;
