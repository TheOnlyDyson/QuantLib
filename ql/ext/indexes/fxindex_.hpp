...
public:
    ...
    Real fixing(const Date& fixingDate, bool forecastTodaysFixing = false, Date& today = Date()) const;
    //@}
    ...
    virtual Real forecastFixing(const Date& fixingDate, const Date& today = Date()) const;
